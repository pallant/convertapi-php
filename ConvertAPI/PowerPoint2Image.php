...
require_once('Abstract2PDF.php');
 ...
 /**
  * Extends the ConvertAPI class to convert PowerPoint documents into Image format
  * via convertapi.com.
  *
  * @see http://www.convertapi.com/powerpoint-pdf-api
  */
class PowerPoint2Image extends Abstract2Pdf {

 /**
  * URL of the appropriate convertapi.com API.
  */
	protected $_apiUrl = 'http://do.convertapi.com/PowerPoint2Image';
